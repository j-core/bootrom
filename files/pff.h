...
/
/----------------------------------------------------------------------------*/
/* Modify by Weibin Nov 15, 2011
 * Added multi-FS support by integrating diskio.h as part of FatFS
 * Added private data so that disk access can support variable speed
 */
...
#define	_USE_LSEEK	1	/* 1:Enable pf_lseek() */ //jin change 0 to 1

#define	_USE_WRITE	1	/* 1:Enable pf_write() */ //jin change 0 to 1

#define _FS_FAT12	1	/* 1:Enable FAT12 support *///jin change 1 to 0
...
#define FS_FAT12	1
#define FS_FAT16	2 //jin notation
#define FS_FAT32	3
