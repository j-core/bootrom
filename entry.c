...
void gdb_illegalinst_isr() { while(1) {} }
void gdb_unhandled_isr() { while(1) {} }
void gdb_addresserr_isr() { while(1) {} }
void gdb_nmi_isr() { while(1) {} }
void gdb_trapa32_isr() { while(1) {} }
void gdb_trapa33_isr() { while(1) {} }
void gdb_trapa34_isr() { while(1) {} }
...
"  jsr @r0\n"
"  nop\n"
/* Either enter GDB stub or infinite loop */
"  trapa #32\n"
"  nop\n"
".align 2\n"
